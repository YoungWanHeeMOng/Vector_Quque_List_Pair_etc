...
void dumpId(bool recurse) {
  ...
  jsonReader.begin(file);
  // find the next field in the document named id. If recurse is specified than subjects will be searched. 
  // Otherwise only objects on this level of the heirarchy are considered.
