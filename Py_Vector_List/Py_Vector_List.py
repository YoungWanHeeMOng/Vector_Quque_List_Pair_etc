...
# bunary tree to doubly linked list
...
def BTToDLLUtil(root):
	...
	Most of the core tack is done by this function."""
	if root is None:
		return root

	#Convert left suntree and link to root
	if root.left:
		# Convert the left subtree
		left=BTToDLLUtil(root.left)

		# Find inorder predecessor, agter this loop, left will point to the inorder predecessor of root
		while (left.right):
			left=left.right
